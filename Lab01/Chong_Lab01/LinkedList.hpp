...
//1. template is OK?
//2. Only insert() erase() need recursive?
//6. After insert any number, does it need to write the result to the file?
//3. how to check memory leak
//4. erase() method cannot delete node
//5. distructor need recursive?